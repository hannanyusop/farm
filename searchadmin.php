...
<body>
  ...
  <div class="input-group">
	...
	<div class="input-group">
	<button type="submit" class="btn" name="searchadmin">Search</button>
  	</div>
  	<p>
      ...
      <tr>
		...
		<?php while($row= mysqli_fetch_array($search_result)):?>
	       <tr>
			...
			<td><a href='updateadmin.php?id=<?php echo $row['id']; ?>& date=<?php echo $row['date'];?>& stallno=<?php echo $row['stallno'];?>& litre=<?php echo $row['litre'];?>& collectedby=<?php echo $row['collectedby'];?>'>Update</a></td>
			<td><a href='deleteadmin.php?id=<?php echo $row['id']; ?>& date=<?php echo $row['date'];?>& stallno=<?php echo $row['stallno'];?>& litre=<?php echo $row['litre'];?>& collectedby=<?php echo $row['collectedby'];?>'>Delete</a></td>
     <?php endwhile;?>
