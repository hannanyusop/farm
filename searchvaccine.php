      ...
      <tr>
		...
		<?php while($row= mysqli_fetch_array($search_result)):?>
	       <tr>
			...
			<td><a href='updatevaccine.php?id=<?php echo $row['id']; ?>& date=<?php echo $row['date'];?>& stallno=<?php echo $row['stallno'];?>& stallno=<?php echo $row['animalid'];?>& vaccine=<?php echo $row['vaccine'];?>& notes=<?php echo $row['notes'];?>'>Update</a></td>
			<td><a href='deletevaccine.php?id=<?php echo $row['id']; ?>& date=<?php echo $row['date'];?>& stallno=<?php echo $row['stallno'];?>& stallno=<?php echo $row['animalid'];?>& vaccine=<?php echo $row['vaccine'];?>& notes=<?php echo $row['notes'];?>'>Delete</a></td>
     <?php endwhile;?>
